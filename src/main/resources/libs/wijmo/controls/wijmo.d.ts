...
declare module wijmo {
    ...
    *
    * This method actually checks whether the browser supports touch events,
    * so it will may true on machines that don't have touch devices, but are
    * running browsers that support touch.
    *
    * A more reliable way of testing for touch in specific events is the
    * @see:Control.isTouching property. You can check the value of that property
    * in the mousedown/move/click events, and it will return true if the event
    * was caused by touch as opposed to mouse action.
    */
